...
export default function Artist() {
  // ✅ 전속작가 섹션 표시 여부 (false면 화면에서 완전히 숨김 / 코드는 유지)
  const hasExclusiveArtist = false;
  ...
  return (
    <section className="bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 md:py-20">
        ...
        <h2
          id="projects"
          className="text-3xl md:text-4xl font-serif font-bold text-ink mb-10 text-center"
        >
          Projects With
        </h2>
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <p className="text-ink/80">
              이상미, 채현정, 강채화, 윤지영, 최정희, 이현정, 박가람, 박지원,
              구지희
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-ink/80">
              백혜숙, 박예반, 최금곤, 윤혜성, 권미선, 신승혜, 양현숙, 박주현,
              이해민
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-ink/80">
              이지성, 권영심, 김성우, 이수향, 천미진, 정다솜, 정현준, 서한나,
              구지희
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-ink/80">
              김섭인, 남주희, 김이엘, 박은정, 이미애, 김지향, 신윤지, 김상현,
              이유림
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-ink/80">
              장도경, 이승비, 이채목, 오현정, 김희정, 오정숙, 이하, 박재영,
              김윤기
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-ink/80">
              박정현, 조유진, 최희주, 윤지선, 김은진, 김란수, 타이미, 이수연,
              안형준
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-ink/80">
              오지우, 백희경, 고희진, 양경혜, 김정은, 문혜영, 함효린, 김은재,
              김경원
            </p>
          </div>
        </div>
